...
\begin{table}[h!]
\centering
\caption{Simulation parameters for synthetic population generation.}
\begin{tabular}{lll}
\toprule
\textbf{Parameter} & \textbf{Symbol} & \textbf{Value / Distribution} \\
\midrule
Baseline hazard rate & $\lambda_0$ & $\text{Uniform}(0.01, 0.05)$ \\
Habit growth rate & $\alpha$ & $\text{Normal}(0.10, 0.02)$ \\
Incentive responsiveness & $\beta$ & $\text{Lognormal}(0.2, 0.1)$ \\
Decay rate & $\delta$ & 0.85 \\

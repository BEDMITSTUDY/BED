...
\begin{figure}[h!]
\centering
\includegraphics[width=0.85\textwidth]{figures/bed_system_architecture.png}
\caption{High-level architecture of the Behavioral Engine for Demand (BED), showing the flow from event logging to behavioral state estimation, CMDP policy evaluation, and incentive delivery.}
\label{fig:bed_architecture}
\end{figure}
